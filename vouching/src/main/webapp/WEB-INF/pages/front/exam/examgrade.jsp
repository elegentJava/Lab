...
<script type="text/javascript" src="<%=bp%>/js/front/exam/examgrade.js" ></script>
<title>查看成绩</title> 
</head>
<body>
		...
		<tr>
			...
			<td align="center" valign="top" class="right_td">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr><td colspan="2" class="weizhi">&nbsp;<strong>首页 ->考试平台 ->查看成绩</strong></td></tr>
				</table>
				<h3 id="exams">选择试卷:<select></select></h3>
				<table width="80%" border="0" cellspacing="1" cellpadding="0" class="content_table1">
					<tr><td colspan="4" class="teatbbai" align="left">成绩</td></tr>
