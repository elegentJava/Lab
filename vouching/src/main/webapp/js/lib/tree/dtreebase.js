...
function dTree(objName) {
	...
	this.icon = {
		...
		root : "/vouching/images/base.gif",

		folder : '/vouching/images/folder.gif',

		folderOpen : '/vouching/images/folderopen.gif',

		node : '/vouching/images/page.gif',

		empty : '/vouching/images/empty.gif',

		line : '/vouching/images/line.gif',

		join : '/vouching/images/join.gif',

		joinBottom : '/vouching/images/joinbottom.gif',

		plus : '/vouching/images/plus.gif',

		plusBottom : '../images/plusbottom.gif',

		minus : '/vouching/images/minus.gif',

		minusBottom : '/vouching/images/minusbottom.gif',

		nlPlus : '/vouching/images/nolines_plus.gif',

		nlMinus : '/vouching/images/nolines_minus.gif'
